...
${navMarkup(current)}
<a class="btn btn-sm" href="/orcamento/">Solicitar avaliação <span class="arrow" aria-hidden="true">→</span></a>
</nav>
</div>
</header>`
...
<a class="footer-phone" href="${attr(whatsapp())}" target="_blank" rel="noopener noreferrer">${esc(contact.whatsappDisplay)}</a>
...
const whatsappFloat = () => `<a class="whatsapp-float" href="${attr(whatsapp())}" target="_blank" rel="noopener noreferrer" aria-label="Falar com a Designer Inox Brasil pelo WhatsApp">
